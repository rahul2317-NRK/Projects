					  ...
					  <ul class="nav-lang">
                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="AdminHome.jsp">Home</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="AddServer.jsp">Add Cloud Server</a></li>
								<li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="CloudServersInfo.jsp">Cloud Server Info</a></li>
            ...
            <div class="carousel-inner" role="listbox">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                               <h1 class="carousel-title">Add CLOUD SERVER</h1>
							<form method="post" action="AddServer">
							<input type="text" name="sname" id="email" value="" placeholder="Server Name" class="panel-title" width="700px;"/>
							<br><br>
							<input type="text" name="sid" id="email" value="" placeholder="Server ID" class="panel-title" width="700px;"/>
							<br><br>
							<input type="password" name="spwd" id="password" value="" placeholder="Password" class="panel-title"/>
							<br><br>
							<input type="submit" value="Add" class="btn-theme btn-theme-sm btn-white-brd text-uppercase" />
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h2 class="carousel-title">Blockchain-based Secure Key Management for Mobile Edge Computing</h2>
