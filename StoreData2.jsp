					  ...
					  <ul class="nav-lang">
                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="MobileUserHome2.jsp">Home</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="ReqForRecovery.jsp">Recovery Request</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="StoreData2.jsp">Store Data</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="ViewData2.jsp">View Data</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="RecoverData.jsp">Recover Data</a></li>
                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            ...
                            <form action="Store2" method="post" enctype="multipart/form-data">
					...
					<td><input type="text" name="name1" class="text-theme text-theme-sm text-white-brd text-uppercase"></td>
					<td><input type="file" name="photo1" class="btn-theme btn-theme-sm btn-white-brd text-uppercase"></td>
