            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                 <h1 class="carousel-title">Cloud Server&nbsp; Request</h1>
                    <br><br>
                  <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
											...
											ResultSet r=DBConnection.getVerifyRequest(sid);
			while(r.next())
			{
					 %>
										 		<tr style="color: white;">
													...
													<td><%= r.getString("tocserver1") %></td>
													<td><%= r.getString("fromcserver2") %></td>
													<td><%= r.getString("pk") %></td>
													<td><%= r.getString("key1") %></td>
												    <td><a href="Verify?rid=<%= r.getString("rid") %>&&email=<%= r.getString("oname") %>">Verify</a></td>
												</tr>
					 <%
				}
											%>
