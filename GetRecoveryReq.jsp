            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                 <h1 class="carousel-title">Mobile Users Recovery Requests</h1>
                    <br><br>
                  <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
											...
											ResultSet r=DBConnection.getUserRecoveryReq();
			while(r.next())
			{
					 %>
										 		<tr style="color: white;">
													...
													<td><%= r.getString("toserver") %></td>
													<td><%= r.getString("fromserver") %></td>
													<td><a href="AcceptRecoveryReq?name=<%= r.getString("name") %>&&email=<%= r.getString("email") %>">Accept Request</a>
												</tr>
					 <%
				}
											%>
