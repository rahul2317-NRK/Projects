        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                          <div class="margin-b-40">
                           <h1 class="carousel-title">Store &nbsp;&nbsp;Data</h1>
                            <form action="Store" method="post" enctype="multipart/form-data">
                            <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" >
					...
					<td><input type="text" name="name" class="text-theme text-theme-sm text-white-brd text-uppercase"></td>
					<td><input type="file" name="photo" class="btn-theme btn-theme-sm btn-white-brd text-uppercase"></td>
					<td><input type="submit" value="Upload" class="btn-theme btn-theme-sm btn-white-brd text-uppercase"></td>
					</tr> 
					</table>
                            </form>
                          </div>
