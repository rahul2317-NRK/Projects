...
<li><div class="dropdown">
 ...
 <%    /*  String cserver=(String)session.getAttribute("sname"); */
		String sql = "select cserver from user where status1='Approved' and cserver='CloudServer2'";
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">Mobile User 2 LOGIN</h1>
							<form method="post" action="User2">
							<input type="text" name="email" id="email" value="" placeholder="Mobile User ID" class="panel-title" width="700px;"/>
							<br><br>
