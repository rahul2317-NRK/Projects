                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                             <h1 class="carousel-title">Mobile Users Info</h1>
                    <br><br>
           <!--      <form action="SendForAthentication.jsp" method=""> -->
                  <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
											<thead>
												<tr style="color: white;">
													...
													<th>To Cloud Server </th>
													<th>Mobile User PK</th>
			...
			while(r.next())
			{
					 %>
										 		<tr style="color: white;">
										 			<td><%= r.getString("rid") %></td>
													<td><%= r.getString("name") %></td>
													<td><%= r.getString("email") %></td>
													<td><%= r.getString("tocserver2") %></td>
													<td><%= r.getString("pk") %></td>
													
													<td><a href="SendForAthentication.jsp?rid=<%= r.getString("rid") %>&&email=<%= r.getString("name") %>">Send</a></td>
												</tr>
					 <%
				}
											%>
