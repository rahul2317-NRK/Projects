...
<html lang="en" class="no-js">
    ...
    <body id="body" data-spy="scroll" data-target=".header">
                        ...
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".nav-collapse">
                          ...
                          <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img logo-img-main" src="" alt="CloudComputing Logo">
                                <img class="logo-img logo-img-active" src="" alt="FlameOnePage Dark Logo">
                            </a>
                        </div>
                    </div>
       ...
       <%
		...
		String sql = "select * from store where userid='"+name+"'";
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
				...
				<td><%=itr.next() %></td>
				<td><%=itr.next() %></td>
				<td><a href="RequestData?da=<%=itr.next()%>" class="w3-button w3-white">View</a>
				<%
				}
				%>
				</table>
