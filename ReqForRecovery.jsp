                  ...
                  <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
											<thead>
												<tr style="color: white;">
													...
													<th>From Cloud Sever</th>
													<th>Recovery Request</th>
												</tr>
											</thead>
											<tbody>
											...
											String sid=(String)session.getAttribute("sname");
											ResultSet r=DBConnection.getUserD(uid);
			while(r.next())
			{
					 %>
										 		<tr style="color: white;">
													...
													<td><a href="RecoveryReq?name=<%= r.getString("name") %>&&email=<%= r.getString("email") %>&&cserver=<%= r.getString("cserver") %>">Send Request</a>
												</tr>
					 <%
				}
											%>
