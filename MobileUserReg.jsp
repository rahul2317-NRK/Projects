                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="index.html">Home</a></li>
                                 <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="Admin.jsp">Admin</a></li>
<li><div class="dropdown">
                         <button class="dropbtn">Cloud Server Login</button>
  						 <div class="dropdown-content">
                         <a href="CloudServer1.jsp">Cloud Server 1</a>
                         <a href="CloudServer2.jsp">Cloud Server 2</a>
                         </div>
                         </div>
                         </li>                                 <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="MobileUser.jsp">Mobile User 1 </a></li>
								 <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="MobileUser2.jsp">Mobile User 2 </a></li>
								<li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="MobileUserReg.jsp">Mobile User Reg</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
      ...
      <%--  <%
		String sql = "select sname from server";
		List<String> lt = DBConnection.getCSName(sql);
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">MOBILE USER LOGIN</h1>
							<form method="post" action="UserReg">
							<input type="text" name="name" id="email" value="" placeholder="Name" class="panel-title" width="700px;"/>
							<input type="text" name="email" id="email" value="" placeholder="Email ID" class="panel-title" width="700px;"/>
							<br><br>
							<input type="text" name="age" id="email" value="" placeholder="Age " class="panel-title" width="700px;"/>
							<input type="text" name="gender" id="email" value="" placeholder="Gender " class="panel-title" width="700px;"/>
							<br><br>
							<input type="password" name="password" id="password" value="" placeholder="Password" class="panel-title"/>
							<input type="text" name="mobile" id="email" value="" placeholder="Mobile" class="panel-title" width="700px;"/>
							<br><br>
							<select name="cserver" placeholder="Select Server" class="panel-title"  width="700px;">
					<option value="0">----select server----</option>
					<option value="CloudServer1">CloudServer1</option>
                    <option value="CloudServer2">CloudServer2</option>
					<%-- <%
					while(itr.hasNext()){
						String vm = itr.next();
					%>
					...
					<br><br>
							<input type="submit" value="Register" class="btn-theme btn-theme-sm btn-white-brd text-uppercase" />
							<input type="reset" value="Reset" class="btn-theme btn-theme-sm btn-white-brd text-uppercase"/>
							</form></div>
                        </div>
                    </div>
                </div>
