...
<html lang="en" class="no-js">
 ...
 <%
		...
		String sql = "select * from recovery where userid='"+name+"' and  cserver='CloudServer1'";
		List<String> lt = DBConnection.getRecoverFile(sql);
		Iterator<String> itr = lt.iterator();
 		%>
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            ...
                            <h1 class="carousel-title">Recovered Data</h1>
                    <br><br>
				...
				<td><%=itr.next() %></td>
				<td><%=itr.next() %></td>
				<td><a href="ViewData2?da=<%=itr.next()%>" class="w3-button w3-white">View</a>
				<%
				}
				%>
				</table>
