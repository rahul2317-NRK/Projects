                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">Add Mobile User</h1>
                                <br> 
                              <%
		session = request.getSession(false);
		String name = (String) session.getAttribute("email");
		String uid = (String) session.getAttribute("sid");
		/* String sql = "select * from user where cserver='"+session.getAttribute("sname")+"' and status1='pending'"; */
		String sql = "select * from user where cserver='CloudServer2' and status1='pending'";
		List<String> lt = DBConnection.getUserRequest(sql);
		Iterator<String> itr = lt.iterator();
		%>
				<table class="w3-table w3-blue" style="width:1150px;text-align: center;text-align: center;" border="1">
				...
				<td><%=vm %></td>
				<td><%=cs %></td>
				<td><a href="ApproveUser2?email=<%=em%>" class="w3-button w3-white">Add</a></td></tr>
				<%} %>
				</table>
                            </div>
