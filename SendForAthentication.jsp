                        ...
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".nav-collapse">
                          ...
                          <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img logo-img-main" src="img/logo.png" alt="CloudComputing Logo">
					  ...
					  <ul class="nav-lang">
                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="CloudServerHome2.jsp">Home</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="AddUsers2.jsp">Add Mobile Users</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="UsersPK2.jsp">Mobile Users PK 2</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="MobileUsersData2.jsp">Mobile Users Data</a></li>
								<li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="CloudUsersInfo2.jsp">Mobile Users Details</a></li>
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                 <h1 class="carousel-title">Send For&nbsp; Authentication</h1>
                                ...
                                String sid=(String)request.getSession().getAttribute("CloudServer2"); 
                                String rid=request.getParameter("rid"); 
                                String oid=request.getParameter("oid"); 
                                String sql="select rid from sharepk where tocserver2='"+sid+"'";
                                String sql1="select name from sharepk where tocserver2='"+sid+"'";
                             //   sql=DBConnection.getRID(sql);
                                List<String> lt=DBConnection.getRID(sql);
                                Iterator<String> itr = lt.iterator();
                                List<String> lt1=DBConnection.getOName(sql1);
                                Iterator<String> itr1 = lt1.iterator();
                              ResultSet rs=DBConnection.getAuthenticationRequest(uid);
                                %>
                             <form action="SendForAthentication" method="get">
                                 <tr style="color: white;">
                                 <td><input type="text" name="rid" value="<%=itr.next() %>" style="width: 150px;color: black;"/></td>
                                 <td><input type="text" name="name" value="<%=itr1.next() %>" style="width: 150px;color: black;"/></td> 
                                 <td><input type="text" name="tocserver2" value="<%=sid %>" style="width: 150px;color: black;"/></td>
                                 <td><input type="text" name="pkey" style="width: 150px;color: black;">
								 <td><a href="SendForAthentication?tocserver2=<%=sid%>">Send</a></td> 
								 </tr>	
                                 </form>
                                 </table> --%>
                               ...
                               <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
                                 ...
                                 <th>Send</th>
											...
											<% 
											ResultSet r=DBConnection.getUserPKDetails();
			while(r.next())
			{
					 %>
                                 <tr style="color: white;">
                                  <td><input type="text" name="rid" value="<%=r.getString("rid") %>" style="width: 150px;color: black;"/></td>
                                 <td><input type="text" name="name" value="<%=r.getString("name") %>" style="width: 150px;color: black;"/></td> 
                                 <td><input type="text" name="fromcserver2" value="<%=r.getString("tocserver2") %>" style="width: 150px;color: black;"/></td>
                                 <td><input type="text" name="pk" value="<%=r.getString("pk") %>" style="width: 150px;color: black;"/></td> 
								 
								 <td><input type="text" name="pkey" placeholder="Enter Private Key" style="width: 150px;color: black;">
			        			  <input type="hidden" name="rid" value="<%=r.getString("rid") %>">
			        			  <input type="hidden" name="name" value="<%=r.getString("name") %>">
			        			  <input type="hidden" name="pk" value=" <%=r.getString("pk")%>"> 
			        			  </td>
			        			  <td><input type="submit" value="Send Private Key " style="width: 150px;color: black;"></td>
			        			  </tr>
                                 </table>
                                 </form>
					 <%
