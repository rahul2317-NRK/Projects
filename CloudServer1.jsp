                ...
                <div class="container">
                      <div class="menu-container js_nav-item">
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".nav-collapse">
                            <span class="sr-only">Blockchain-based Secure Key Management for Mobile Edge Computing</span>
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">CLOUD SERVER 1 LOGIN</h1>
							<form method="post" action="Server1">
							<input type="text" name="sid" id="email" value="" placeholder="Cloud Server ID" class="panel-title" width="700px;"/>
							<br><br>
							<input type="password" name="spwd" id="password" value="" placeholder="Password" class="panel-title"/>
							<br><br>
							<input type="submit" value="Login" class="btn-theme btn-theme-sm btn-white-brd text-uppercase" />
